...
export function readIntent(text) {
  ...
  const demand = (has(/\b(i demand|you will|you must|you shall|i command|i order|i insist|surrender|hand over|give me|pay me|yield|open (the|your)|release|free|bend the knee|you (come|obey|answer|send|march|ride|kneel)\b|is that understood|see that you|i expect you|i want you to|you are to)\b/) && !has(/\bwill you\b/)) || threat; // a threat is a demand with teeth
